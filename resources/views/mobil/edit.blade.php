    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('tipe') is-invalid @enderror" wire:model="tipe"
                                    id="tipe">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('tahun') is-invalid @enderror"
                                    wire:model="tahun" id="tahun" min="1900" max="2030" placeholder="2023">
                                @error('tahun')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="platnomor" class="form-label">Plat Nomor <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('platnomor') is-invalid @enderror"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('kapasitas') is-invalid @enderror"
                                    wire:model="kapasitas" id="kapasitas" min="1" placeholder="Contoh: 7">
                                @error('kapasitas')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            <div class="modal-footer sticky-bottom bg-white border-top">
                <button type="button" class="btn btn-secondary me-2" wire:click="cancel">Batal</button>
...
<style>
    /* Custom CSS untuk modal scrollable */
